            ...
            <div class="box-publicar" id="publi-detalles">
                <form name="info-venta" class="info-venta">
                    <ul>
                        ...
                        <li><label>Direccion (Arrastrar el marcador para actualizar la posiciónArrastrar el marcador para actualizar la posición  y para mejorar la posición debe acercar el mapa)</label></li>
                        <li>
                            <div class="local-map">
                        ...
                        <li><label>Tamaño de la Construcción</label></li>
                        <li>
                        ...
                        <li><input type="text" style='border: 5px solid #439a00;border-radius: 8px;box-shadow: 0 1px 0 rgba(255, 255, 255, 0.3) inset, 0 1px 2px rgba(0, 0, 0, 0.7);display: inline-block;font: 14px "Helvetica Neue" ,Helvetica,Arial,sans-serif;margin-bottom: 20px;padding: 6px 10px;position: relative;width: 320px;'name="tamano-frente" id="tamano-frente" value="" class="numbersOnly">
                            <label style="display: inline-block">metros</label>
                        </li>
                        ...
                        <li><label>Cantidad Pisos o Niveles</label></li>
                        <li>
